import {
  ...
  static TABS = {
    primary: {
      ...
      initial: "inventory",
      labelPrefix: "BOILERPLATE.Actor.Tabs",
    },
  };
	...
	_configureRenderOptions(options) {
	  ...
	  switch (this.document.type) {
		case 'person':
		  options.parts.push('header', 'inventory', 'skills', 'traits');
		  break;
		case 'monster':
		  options.parts.push('header', 'inventory', 'skills', 'traits');
		  break;
    ...
    if (group === "primary") {
      if (this.document.limited) {
        ...
        return { inventory: tabs.inventory };
      }
	...
	_prepareItems(context) {
	  ...
	  for (let i of this.document.items) {
		...
		//keeping this as an example. sort wearables like this! -s
